      ...
      questions: [
        {
          ...
          answers: { a: "locate()", b: "search()", c: "strpos()", d: "Ничего из вышеперечисленного" },
          correctAnswer: "b",
        },
        {
          question: "Какая из следующих магических констант PHP возвращает имя функции?",
          answers: { a: "_CLASS_", b: "_FUNCTION_", c: "_FILE_", d: "_LINE_" },
          correctAnswer: "d",
        },
        {
          question:
            "Что означает PHP?",
          answers: { a: "Preprocessor Home Page", b: "Pretext Hypertext Processor" },
          correctAnswer: "b",
        },
      ],
    };
