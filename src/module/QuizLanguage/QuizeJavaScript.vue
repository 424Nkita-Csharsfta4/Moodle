  ...
  data() {
    return {
      ...
      questions: [
        {
          question:
            "JavaScript имеет следующий тип комментариев.",
          answers: { a: "Однострочные комментарии", b: "Все вышеперечисленное", c: "Многострочные комментарии",
           d: "Ни один из вышеперечисленных" },
          correctAnswer: "b",
        },
        {
          question: "Что из перечисленного считается концом однострочного комментария?",
          answers: { a: "Ни один из вышеперечисленных", b: "Конец инструкции", c: "Точка с запятой", d: "Конец строки" },
          correctAnswer: "d",
        },
        {
          question:
            "Переменная может одновременно содержать _____ значений.",
          answers: { a: "Несколько", b: "Одно" },
          correctAnswer: "b",
        },
      ],
    };
