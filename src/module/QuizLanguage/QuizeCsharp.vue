      ...
      questions: [
        {
          ...
          answers: { a: "int arr = [2, 5];", b: "int arr[] = {2, 5};", c: "int[] arr = new int [2] {2, 5};", d: "int arr = {2, 5};" },
          correctAnswer: "b",
        },
        {
          question: "Какое из следующих утверждений об объектах в C# является правильным?",
          answers: { a: "У объектов есть методы и события, которые позволяют им выполнять действия.",
           b: "Все объекты, созданные из класса, будут занимать в памяти одинаковое количество байтов.",
            c: "Все вышеперечисленное",
             d: "Все, что вы используете в C#, - это объект, включая Windows Forms и элементы управления." },
          correctAnswer: "d",
        },
        {
          question:
            "Какое из следующих ключевых слов используется для включения пространств имен в программу на C#?",
          answers: { a: "imports", b: "using" },
          correctAnswer: "b",
        },
      ],
    };
