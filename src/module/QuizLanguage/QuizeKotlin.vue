      ...
      questions: [
        {
          ...
          answers: { a: "На базе платформы Intellij IDEA", b: "На базе Java Virtual Machine", c: "На базе языка Python", d: "На базе языка C++" },
          correctAnswer: "b",
        },
        {
          question: "Где неверно создана переменная?",
          answers: { a: "var char = 'S'", b: "var num = 50;", c: "var isGet = null", d: "val str: String = null" },
          correctAnswer: "d",
        },
        {
          question:
            "Какая функция служит для вывода данных?",
          answers: { a: "write()", b: "print()" },
          correctAnswer: "b",
        },
      ],
    };
